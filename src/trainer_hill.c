...
} static const sTrainerClassesAndMusic[] =
{
    ...
    {TRAINER_CLASS_PATH_GUARDIAN, TRAINER_ENCOUNTER_MUSIC_FEMALE},
...
static const u16 sPrizeListTorment[]     = {ITEM_TM_RECOVER,       ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
