...
static const u8 sMapPopUp_Table[][960] =
{
    ...
    [MAPPOPUP_THEME_ROUTE]     = INCBIN_U8("graphics/map_popup/route.4bpp"),
    ...
    [MAPPOPUP_THEME_FOREST]     = INCBIN_U8("graphics/map_popup/forest.4bpp"),
};

static const u8 sMapPopUp_OutlineTable[][960] =
{
    [MAPPOPUP_THEME_TOWN]       = INCBIN_U8("graphics/map_popup/town_outline.4bpp"),
    [MAPPOPUP_THEME_ROUTE]     = INCBIN_U8("graphics/map_popup/route_outline.4bpp"),
...
{
    [MAPPOPUP_THEME_TOWN]       = INCBIN_U16("graphics/map_popup/town.gbapal"),
    [MAPPOPUP_THEME_ROUTE]     = INCBIN_U16("graphics/map_popup/route_outline.gbapal"),
    ...
    [MAPPOPUP_THEME_FOREST]     = INCBIN_U16("graphics/map_popup/forest_outline.gbapal"),
};
...
{
    [MAPSEC_LITTLEROOT_TOWN] = MAPPOPUP_THEME_CITY,
    [MAPSEC_OLDALE_TOWN] = MAPPOPUP_THEME_TOWN,
    [MAPSEC_DEWFORD_TOWN] = MAPPOPUP_THEME_TOWN,
    [MAPSEC_LAVARIDGE_TOWN] = MAPPOPUP_THEME_TOWN,
    [MAPSEC_FALLARBOR_TOWN] = MAPPOPUP_THEME_TOWN,
    [MAPSEC_VERDANTURF_TOWN] = MAPPOPUP_THEME_TOWN,
    [MAPSEC_PACIFIDLOG_TOWN] = MAPPOPUP_THEME_TOWN,
    [MAPSEC_PETALBURG_CITY] = MAPPOPUP_THEME_CITY,
    [MAPSEC_SLATEPORT_CITY] = MAPPOPUP_THEME_ROUTE,
    [MAPSEC_MAUVILLE_CITY] = MAPPOPUP_THEME_ROUTE,
    [MAPSEC_RUSTBORO_CITY] = MAPPOPUP_THEME_CITY,
    [MAPSEC_FORTREE_CITY] = MAPPOPUP_THEME_CITY,
    [MAPSEC_LILYCOVE_CITY] = MAPPOPUP_THEME_ROUTE,
    [MAPSEC_MOSSDEEP_CITY] = MAPPOPUP_THEME_CITY,
    [MAPSEC_SOOTOPOLIS_CITY] = MAPPOPUP_THEME_ROUTE,
    [MAPSEC_EVER_GRANDE_CITY] = MAPPOPUP_THEME_CITY,
    ...
    [MAPSEC_ROUTE_110] = MAPPOPUP_THEME_TOWN,
    [MAPSEC_ROUTE_111] = MAPPOPUP_THEME_TOWN,
    [MAPSEC_ROUTE_112] = MAPPOPUP_THEME_TOWN,
    [MAPSEC_ROUTE_113] = MAPPOPUP_THEME_TOWN,
    [MAPSEC_ROUTE_114] = MAPPOPUP_THEME_TOWN,
    [MAPSEC_ROUTE_115] = MAPPOPUP_THEME_TOWN,
    [MAPSEC_ROUTE_116] = MAPPOPUP_THEME_TOWN,
    [MAPSEC_ROUTE_117] = MAPPOPUP_THEME_TOWN,
    [MAPSEC_ROUTE_118] = MAPPOPUP_THEME_TOWN,
    [MAPSEC_ROUTE_119] = MAPPOPUP_THEME_TOWN,
    [MAPSEC_ROUTE_120] = MAPPOPUP_THEME_TOWN,
    [MAPSEC_ROUTE_121] = MAPPOPUP_THEME_TOWN,
    [MAPSEC_ROUTE_122] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_ROUTE_123] = MAPPOPUP_THEME_TOWN,
    ...
    [MAPSEC_UNDERWATER_124] = MAPPOPUP_THEME_FOREST,
    [MAPSEC_UNDERWATER_126] = MAPPOPUP_THEME_FOREST,
    [MAPSEC_UNDERWATER_127] = MAPPOPUP_THEME_FOREST,
    [MAPSEC_UNDERWATER_128] = MAPPOPUP_THEME_FOREST,
    [MAPSEC_UNDERWATER_SOOTOPOLIS] = MAPPOPUP_THEME_FOREST,
    [MAPSEC_GRANITE_CAVE] = MAPPOPUP_THEME_STONE,
    [MAPSEC_MT_CHIMNEY] = MAPPOPUP_THEME_STONE,
    [MAPSEC_SAFARI_ZONE] = MAPPOPUP_THEME_TOWN,
    [MAPSEC_BATTLE_FRONTIER] = MAPPOPUP_THEME_ROUTE,
    [MAPSEC_PETALBURG_WOODS] = MAPPOPUP_THEME_FOREST,
    [MAPSEC_RUSTURF_TUNNEL] = MAPPOPUP_THEME_STONE,
    [MAPSEC_ABANDONED_SHIP] = MAPPOPUP_THEME_TOWN,
    [MAPSEC_NEW_MAUVILLE] = MAPPOPUP_THEME_ROUTE,
    ...
    [MAPSEC_UNDERWATER_SEAFLOOR_CAVERN] = MAPPOPUP_THEME_FOREST,
    [MAPSEC_VICTORY_ROAD] = MAPPOPUP_THEME_STONE,
    [MAPSEC_MIRAGE_ISLAND] = MAPPOPUP_THEME_TOWN,
    [MAPSEC_CAVE_OF_ORIGIN] = MAPPOPUP_THEME_STONE,
    [MAPSEC_SOUTHERN_ISLAND] = MAPPOPUP_THEME_TOWN,
    [MAPSEC_FIERY_PATH] = MAPPOPUP_THEME_STONE,
    [MAPSEC_FIERY_PATH2] = MAPPOPUP_THEME_STONE,
    [MAPSEC_JAGGED_PASS] = MAPPOPUP_THEME_TOWN,
    [MAPSEC_JAGGED_PASS2] = MAPPOPUP_THEME_TOWN,
    [MAPSEC_SEALED_CHAMBER] = MAPPOPUP_THEME_STONE,
    [MAPSEC_UNDERWATER_SEALED_CHAMBER] = MAPPOPUP_THEME_FOREST,
    ...
    [MAPSEC_INSIDE_OF_TRUCK] = MAPPOPUP_THEME_TOWN,
    [MAPSEC_SKY_PILLAR] = MAPPOPUP_THEME_STONE,
    [MAPSEC_SECRET_BASE] = MAPPOPUP_THEME_STONE,
    [MAPSEC_DYNAMIC] = MAPPOPUP_THEME_ROUTE,
    ...
    [MAPSEC_BIRTH_ISLAND - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_TOWN,
    [MAPSEC_FARAWAY_ISLAND - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_TOWN,
    [MAPSEC_ARTISAN_CAVE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
    [MAPSEC_MARINE_CAVE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
    [MAPSEC_UNDERWATER_MARINE_CAVE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_FOREST,
    [MAPSEC_TERRA_CAVE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
    [MAPSEC_UNDERWATER_105 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_FOREST,
    [MAPSEC_UNDERWATER_125 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_FOREST,
    [MAPSEC_UNDERWATER_129 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_FOREST,
    ...
    [MAPSEC_TRAINER_HILL - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_ROUTE,
};
