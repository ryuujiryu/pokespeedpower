...
const u8 gText_PkmnBleedHealed[] = _("{STR_VAR_1}'s bleeding was healed.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_XNatureMetAtYZ[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5} nature, met at {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}, {DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}.");
...
const u8 gText_PlayerScurriedToCenter[] = _("{PLAYER} scurried to a POKéMON LODGE,\nprotecting the exhausted and fainted\nPOKéMON from further harm…\p");
...
const u8 gText_MenuPlayer[] = _("PASS");
