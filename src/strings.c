...
const u8 gText_BirchInTrouble[] = _("Quick! You have to help\nPROF. ZELKOVA! Choose a POKéMON!");
...
const u8 gText_SomeonesPC[] = _("{PKMN} HOSTING SYSTEM");
const u8 gText_LanettesPC[] = _("LANETTE'S PC");
const u8 gText_PlayersPC[] = _("CODEWEAVER FORUM");
