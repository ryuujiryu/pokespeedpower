...
static const struct MenuAction sMenuActions_Gender[] = {
    {COMPOUND_STRING("PHOTO 1"), {NULL}},
    {COMPOUND_STRING("PHOTO 2"), {NULL}}
};

static const u8 *const sMalePresetNames[] = {
    COMPOUND_STRING("SHINYA"),
    COMPOUND_STRING("HECTOR"),
    COMPOUND_STRING("RICKY"),
    COMPOUND_STRING("ALVARO"),
    COMPOUND_STRING("GERARD"),
    COMPOUND_STRING("ERIK"),
    COMPOUND_STRING("DAEWON")
};

static const u8 *const sFemalePresetNames[] = {
    COMPOUND_STRING("FUUKA"),
    COMPOUND_STRING("LEONA"),
    COMPOUND_STRING("IRENE"),
    COMPOUND_STRING("ELSA"),
    COMPOUND_STRING("BRIGITTE"),
    COMPOUND_STRING("KARA"),
    COMPOUND_STRING("TAEHA")
};
