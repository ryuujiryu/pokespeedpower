...
{
    HOENN_TO_NATIONAL(MASALIZARD),
    HOENN_TO_NATIONAL(HABANAGA),
    HOENN_TO_NATIONAL(TABASILISK),
    HOENN_TO_NATIONAL(ELEPHLUSH),
    HOENN_TO_NATIONAL(ELEPHUSION),
    HOENN_TO_NATIONAL(ELEPHANTEA),
    HOENN_TO_NATIONAL(LOTPOLE),
    HOENN_TO_NATIONAL(PADMARA),
    HOENN_TO_NATIONAL(PADMANDUKA),
    HOENN_TO_NATIONAL(TANOOK),
    HOENN_TO_NATIONAL(TANOOKING),
    HOENN_TO_NATIONAL(LEDYBA),
    HOENN_TO_NATIONAL(LEDIAN),
    HOENN_TO_NATIONAL(LEDIRO),
    HOENN_TO_NATIONAL(SCAVULT),
    HOENN_TO_NATIONAL(ASCLYPAS),
    HOENN_TO_NATIONAL(CHERUBI),
    HOENN_TO_NATIONAL(CHERRIM),
    HOENN_TO_NATIONAL(KRICKETOT),   
    HOENN_TO_NATIONAL(KRICKETUNE),
    HOENN_TO_NATIONAL(KRICKESTRO),
    HOENN_TO_NATIONAL(PAWTRAIN),
    HOENN_TO_NATIONAL(KEYNAIN),
    ...
    HOENN_TO_NATIONAL(CHIMENCORE),
    HOENN_TO_NATIONAL(WINGULL),
    HOENN_TO_NATIONAL(PELIPPER),
    HOENN_TO_NATIONAL(TEMAKOI),
    HOENN_TO_NATIONAL(URAMAKON),
    ...
    for (i = 0; i < ITEM_EFFECT_ARG_START; i++)
    {
        ...
        case 3:
            ...
            if ((itemEffect[i] & ITEM3_PARALYSIS) && HealStatusConditions(mon, STATUS1_PARALYSIS, battler) == 0)
                retVal = FALSE;
            if ((itemEffect[i] & ITEM3_BLEED) && HealStatusConditions(mon, STATUS1_BLEED, battler) == 0)
                retVal = FALSE;
            break;
...
u16 GetBattleBGM(void)
{
    ...
    else if (gBattleTypeFlags & BATTLE_TYPE_TRAINER)
    {
        ...
        case TRAINER_CLASS_PATH_GUARDIAN:
            return MUS_FIGHTING_OF_THE_SPIRIT;
