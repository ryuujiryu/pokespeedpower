...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_AQUA_ADMIN] = { _("ARC GENERAL"), 10 },
...
const u8 gStatusConditionString_BleedJpn[] = _("ねり$$$$$");
