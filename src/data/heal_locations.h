static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE - 1] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), 5, 17},
    [HEAL_LOCATION_LITTLEROOT_TOWN_MAYS_HOUSE - 1] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), 16, 14},
    ...
    [HEAL_LOCATION_PRELUDIO_TOWN - 1] = {MAP_GROUP(PRELUDIO_TOWN), MAP_NUM(PRELUDIO_TOWN), 18, 12},
    [HEAL_LOCATION_MELODY_CITY - 1] = {MAP_GROUP(MELODY_CITY), MAP_NUM(MELODY_CITY), 17, 17},
};
