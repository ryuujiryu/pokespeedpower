...
const struct Tileset gTileset_Preludiosharport =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Preludiosharport,
    .palettes = gTilesetPalettes_Preludiosharport,
    .metatiles = gMetatiles_Preludiosharport,
