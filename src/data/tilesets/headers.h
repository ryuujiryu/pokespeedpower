...
const struct Tileset gTileset_CitrusIsland =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_CitrusIsland,
    .palettes = gTilesetPalettes_CitrusIsland,
    .metatiles = gMetatiles_CitrusIsland,
    .metatileAttributes = gMetatileAttributes_CitrusIsland,
    .callback = NULL,
};
...
const struct Tileset gTileset_Coconut =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Coconut,
...
const struct Tileset gTileset_JapaneseBuilding =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_JapaneseBuilding,
    .palettes = gTilesetPalettes_JapaneseBuilding,
    .metatiles = gMetatiles_JapaneseBuilding,
    .metatileAttributes = gMetatileAttributes_JapaneseBuilding,
    .callback = NULL,
};
