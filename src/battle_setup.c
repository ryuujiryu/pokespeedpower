...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_ROXANNE] = REMATCH(TRAINER_SHIRI_AND_BANJO_1, TRAINER_SHIRI_AND_BANJO_2, TRAINER_SHIRI_AND_BANJO_3, TRAINER_SHIRI_AND_BANJO_4, TRAINER_SHIRI_AND_BANJO_5, MAP_RUSTBORO_CITY),
