...
static const u8 sText_TwoWildPkmnAppeared[] = _("Wild {B_OPPONENT_MON1_NAME} and {B_OPPONENT_MON2_NAME} detected!\p");
static const u8 sText_Trainer1WantsToBattle[] = _("Initializing battle vs. {B_TRAINER1_NAME_WITH_CLASS}!\p");
...
static const u8 sText_GoPkmn[] = _("VISUALIZE! Go, {B_PLAYER_MON1_NAME}!");
static const u8 sText_GoTwoPkmn[] = _("VISUALIZE! Go, {B_PLAYER_MON1_NAME} and {B_PLAYER_MON2_NAME}!");
static const u8 sText_GoPkmn2[] = _("VISUALIZE! Go, {B_BUFF1}!");
...
static const u8 sText_TwoTrainersWantToBattle[] = _("Initializing battle vs. {B_TRAINER1_NAME_WITH_CLASS} and {B_TRAINER2_NAME_WITH_CLASS}!\p");
