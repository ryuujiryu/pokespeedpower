...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_HARSHWINDS]                           = COMPOUND_STRING("Sharp winds are hitting the air around {B_DEF_TEAM2} team!"),
    ...
    [STRINGID_WINDSHEARDMG]                         = COMPOUND_STRING("Harsh winds cut into {B_SCR_NAME_WITH_PREFIX2}!"),
    ...
    [STRINGID_WINDSHEARDISAPPEAREDFROMTEAM]         = COMPOUND_STRING("The sharp winds disappeared from around {B_ATK_TEAM2} team!"),
    ...
    [STRINGID_POWERCHORDCHARGING]                   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} tuned the frequencies!"),
...
const u16 gDmgHazardsStringIds[] =
{
    ...
    [B_MSG_WINDSHEARDMG]       = STRINGID_WINDSHEARDMG,
    [B_MSG_SHARPSTEELDMG]      = STRINGID_SHARPSTEELDMG,
    [B_MSG_POINTEDSTONESFLOAT] = STRINGID_POINTEDSTONESFLOAT,
    [B_MSG_HARSHWINDS]         = STRINGID_HARSHWINDS,
...
const u16 gDefogHazardsStringIds[] =
{
    ...
    [HAZARDS_WINDSHEAR] = STRINGID_WINDSHEARDISAPPEAREDFROMTEAM,
...
const u16 gSpinHazardsStringIds[] =
{
    ...
    [HAZARDS_WINDSHEAR] = STRINGID_PKMNBLEWAWAYWINDSHEAR,
