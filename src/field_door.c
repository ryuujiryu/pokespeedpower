...
static const u8 sDoorAnimTiles_CitrusIsland[] = INCBIN_U8("graphics/door_anims/citrus_island_citrus_door.4bpp");
static const u16 sDoorNullPalette50[16] = {};
static const u8 sDoorAnimTiles_MossdeepTemple[] = INCBIN_U8("graphics/door_anims/mossdeep_temple.4bpp");
...
static const u8 sDoorAnimPalettes_PokeCenter[] = {1, 1, 1, 1, 3, 3, 3, 3};
...
static const u8 sDoorAnimPalettes_CitrusIsland[] = {7, 7, 7, 7, 7, 7, 7, 7};
static const u8 sDoorAnimPalettes_MossdeepTemple[] = {11, 11, 11, 11, 11, 11, 11, 11};

static const struct DoorGraphics sDoorAnimGraphicsTable[] =
{
    {METATILE_General_Door,                                 DOOR_SOUND_NORMAL,  1, sDoorAnimTiles_General, sDoorAnimPalettes_General},
    {METATILE_General_Door_PokeCenter,                      DOOR_SOUND_NORMAL, 1, sDoorAnimTiles_PokeCenter, sDoorAnimPalettes_PokeCenter},
    {METATILE_General_Door_Gym,                             DOOR_SOUND_NORMAL, 1, sDoorAnimTiles_Gym, sDoorAnimPalettes_Gym},
    ...
    {METATILE_CitrusIsland_Door,                            DOOR_SOUND_NORMAL,  1, sDoorAnimTiles_CitrusIsland, sDoorAnimPalettes_CitrusIsland},
    {METATILE_Mossdeep_Temple,                              DOOR_SOUND_NORMAL,  1, sDoorAnimTiles_MossdeepTemple, sDoorAnimPalettes_MossdeepTemple},
    {},
};
