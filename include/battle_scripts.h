...
extern const u8 BattleScript_TargetBleedHeal[];
...
extern const u8 BattleScript_EffectExposure[];
...
extern const u8 BattleScript_AlreadyBleeding[];
...
extern const u8 BattleScript_EffectWindshear[];
