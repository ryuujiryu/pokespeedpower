...
enum TypeSideHazard
{
    ...
    TYPE_SIDE_HAZARD_HARSH_WINDS    = TYPE_FLYING,
};
...
#define B_WEATHER_ACID_RAIN     (1 << BATTLE_WEATHER_ACID_RAIN)
#define B_WEATHER_STRONG_WINDS  (1 << BATTLE_WEATHER_STRONG_WINDS)
#define B_WEATHER_CROWD         (1 << BATTLE_WEATHER_CROWD)
#define B_WEATHER_ECLIPSE       (1 << BATTLE_WEATHER_ECLIPSE)
#define B_WEATHER_METEORS       (1 << BATTLE_WEATHER_METEORS)

#define B_WEATHER_ANY           (B_WEATHER_RAIN | B_WEATHER_SANDSTORM | B_WEATHER_SUN | B_WEATHER_HAIL | B_WEATHER_STRONG_WINDS | B_WEATHER_SNOW | B_WEATHER_FOG | B_WEATHER_ACID_RAIN | B_WEATHER_CROWD | B_WEATHER_ECLIPSE | B_WEATHER_METEORS)
#define B_WEATHER_DAMAGING_ANY  (B_WEATHER_HAIL | B_WEATHER_SANDSTORM | B_WEATHER_ACID_RAIN)
#define B_WEATHER_ICY_ANY       (B_WEATHER_HAIL | B_WEATHER_SNOW)
#define B_WEATHER_LOW_LIGHT     (B_WEATHER_FOG | B_WEATHER_ICY_ANY | B_WEATHER_RAIN | B_WEATHER_SANDSTORM | B_WEATHER_ACID_RAIN | B_WEATHER_ECLIPSE | B_WEATHER_METEORS)
