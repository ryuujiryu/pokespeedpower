...
enum StringID
{
    ...
    STRINGID_WINDSHEARDISAPPEAREDFROMTEAM,
    ...
    STRINGID_WINDSHEARDMG,
    STRINGID_PKMNBLEWAWAYWINDSHEAR,
    ...
    STRINGID_SPINTHESLOT,
    STRINGID_PKMNHURTBYACIDRAIN,
    STRINGID_STARTEDACIDRAIN,
    STRINGID_ACIDRAINCONTINUES,
    STRINGID_ACIDRAINSTOPPED,
    STRINGID_EXCITEDCROWD,
    STRINGID_HYPEDCROWD,
    STRINGID_BOREDCROWD,
    STRINGID_MOONRISING,
    STRINGID_MOONSHINING,
    STRINGID_MOONFALLING,
...
enum MoveWeatherChangeStringID
{
    ...
    B_MSG_STARTED_FOG,
    B_MSG_STARTED_CROWD,
    B_MSG_STARTED_ECLIPSE,
    B_MSG_STARTED_METEORS,
};
...
enum WeatherEndStringID
{
    ...
    B_MSG_WEATHER_END_CROWD,
    B_MSG_WEATHER_END_ECLIPSE,
    B_MSG_WEATHER_END_METEORS,
...
enum WeatherTurnStringID
{
    ...
    B_MSG_WEATHER_TURN_CROWD,
    B_MSG_WEATHER_TURN_ECLIPSE,
    B_MSG_WEATHER_TURN_METEORS,
};
