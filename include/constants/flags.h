...
#define FLAG_RECEIVED_TM_BODY_SLAM              0xE5
...
#define FLAG_RIVAL_CITRUS  0x264
#define FLAG_RIVAL_CITRUSISLAND  0x265
...
#define FLAG_VISITED_DURIAN_TOWN                    (SYSTEM_FLAGS + 0x85) // Unused Flag
