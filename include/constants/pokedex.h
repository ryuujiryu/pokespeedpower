...
enum NationalDexOrder
{
    ...
    NATIONAL_DEX_MASALIZARD,
    NATIONAL_DEX_HABANAGA,
    NATIONAL_DEX_TABASILISK,
    NATIONAL_DEX_ELEPHLUSH,
    NATIONAL_DEX_ELEPHUSION,
    NATIONAL_DEX_ELEPHANTEA,
    NATIONAL_DEX_LOTPOLE,
    NATIONAL_DEX_PADMARA,
    NATIONAL_DEX_PADMANDUKA,
    NATIONAL_DEX_TANOOK,
    NATIONAL_DEX_TANOOKING,
    NATIONAL_DEX_LEDIRO,
    NATIONAL_DEX_SCAVULT,
    NATIONAL_DEX_ASCLYPAS,
    NATIONAL_DEX_KRICKESTRO,
    NATIONAL_DEX_PAWTRAIN,
    NATIONAL_DEX_KEYNAIN,
    NATIONAL_DEX_KURSTRAW,
    NATIONAL_DEX_PANGSHI,
    NATIONAL_DEX_CHIMENCORE,
    NATIONAL_DEX_TEMAKOI,
    NATIONAL_DEX_URAMAKON,
};
...
#define JOHTO_DEX_COUNT     NATIONAL_DEX_CELEBI
    ...
    #define NATIONAL_DEX_COUNT  NATIONAL_DEX_CHIMENCORE
...
{
    HOENN_DEX_NONE,
    HOENN_DEX_MASALIZARD,
    HOENN_DEX_HABANAGA,
    HOENN_DEX_TABASILISK,
    HOENN_DEX_ELEPHLUSH,
    HOENN_DEX_ELEPHUSION,
    HOENN_DEX_ELEPHANTEA,
    HOENN_DEX_LOTPOLE,
    HOENN_DEX_PADMARA,
    HOENN_DEX_PADMANDUKA,
    HOENN_DEX_TANOOK,
    HOENN_DEX_TANOOKING,
    HOENN_DEX_LEDYBA,
    HOENN_DEX_LEDIAN,
...
#define HOENN_DEX_COUNT (HOENN_DEX_POLITOED + 1)
